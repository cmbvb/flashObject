package com.canaan.lib.role.view
{
	...
	public class AbstractView extends BaseSprite
	{
		 ...
		 * 
		 */			
		public function addRenderPart(type:int = 0, actionVo:ActionVo = null, partClass:Class = null):IRenderPart {
		 ...
		 * 
		 */		
		protected function refreshPartDepth():void {
			_renderParts.sort(renderPartSortFunc);
			_containerParts.removeAllChildren();
