package com.canaan.lib.algorithm.behaviorTree.operator
{
	...
	public class BevNodePreconditionYES extends BevNodePrecondition
	{
		protected var mLeftCondition:BevNodePrecondition;								// 操作符左侧条件
		
		public function BevNodePreconditionYES(leftCondition:BevNodePrecondition = null)
		{
		...
		override public function clone():BevNodePrecondition {
			return new BevNodePreconditionYES(mLeftCondition);
		}
	}
}