...
package com.canaan.lib.component.controls {
	...
	public class Slider extends UIComponent {
		...
		protected function onButtonMouseDown(e:MouseEvent):void {
			...
			StageManager.getInstance().stage.addEventListener(MouseEvent.MOUSE_MOVE, onStageMouseMove);
		...
		protected function sendChangeEvent():void {
			...
			if (_changeHandler != null) {
				_changeHandler.applyWith([_value]);
			}
		}
		...
		public function justSetValue(num:Number):void {
			if (_value != num) {
				_value = num;
				changeValue();
			}
