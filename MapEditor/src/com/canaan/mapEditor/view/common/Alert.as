package com.canaan.mapEditor.view.common
{
	import com.canaan.lib.core.Method;
	import com.canaan.lib.managers.KeyboardManager;
	import com.canaan.mapEditor.ui.common.AlertUI;
	...
	public class Alert extends AlertUI
	{
		...
		public static function get isPopup():Boolean {
			return alert != null && alert.isPopup;
		}
		...
		public function showText(text:String = "", type:int = 1, sureCallback:Method = null, cancelCallback:Method = null):void {
			...
			KeyboardManager.getInstance().registerHandler(Keyboard.ESCAPE, false, close, ["close"]);
			KeyboardManager.getInstance().registerHandler(Keyboard.ENTER, false, close, ["sure"]);
		}
