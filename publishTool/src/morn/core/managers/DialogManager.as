...
package morn.core.managers {
	...
	public class DialogManager extends Sprite {
		...
		private var dialogDic:Dictionary = new Dictionary();
		...
		public function popupByClazz(clazz:Class, closeOther:Boolean = false):void {
			if (dialogDic[clazz] == null) {
				dialogDic[clazz] = new clazz();
			}
			var dialog:Dialog = dialogDic[clazz];
			popup(dialog, closeOther);
		}
