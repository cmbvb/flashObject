...
{
	private static var mPool:Vector.<DoubleClickItem> = new Vector.<DoubleClickItem>();
	...
	public static function fromPool():DoubleClickItem {
		return mPool.length != 0 ? mPool.pop() : new DoubleClickItem();
	}
	
	public static function toPool(doubleClickItem:DoubleClickItem):void {
		doubleClickItem.poolDestory();
		mPool.push(doubleClickItem);
	}
}