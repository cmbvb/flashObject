...
package com.canaan.lib.component.controls {
	...
	public class ViewStack extends Box implements IItem {
		...
		protected var _setIndexHandler:Method = new Method(setIndex);
		...
		public function get setIndexHandler():Method {
			return _setIndexHandler;
		}
		
		public function set setIndexHandler(value:Method):void {
