...
{
	import com.canaan.lib.component.ICompositeComponent;
	 ...
	 * 
	 */
	public class Paging extends Container implements ICompositeComponent
	{
		//------组件
		...
		protected function changePaging():void
		{
			if(_compositeXML == null){
				_bg.x = offsetBg;
				_upButton.x = 2;
				_upButton.y = (height - _upButton.height) / 2;
				
				_downButton.x = width - _downButton.width - 2;
				_downButton.y = (height - _downButton.height) / 2;
		...
		public function get upButtonLabel():String {
			return _upButton.label;
		}
		
		public function set upButtonLabel(value:String):void {
			_upButton.label = value;
		}
		
		public function get downButtonLabel():String {
			return _downButton.label;
		}
		
		public function set downButtonLabel(value:String):void {
			_downButton.label = value;
		}
		
		public function get buttonLabelColors():String {
			return _upButton.labelColors;
		}
		
		public function set buttonLabelColors(value:String):void {
			_upButton.labelColors = value;
			_downButton.labelColors = value;
		}
		...
		public function setPageOnly(currentPage:int, totalPage:int):void {
		...
		public function get changeHandler():Method
		{
			return _changeHandler;
		}
		
		public function set changeHandler(value:Method):void
		{
		...
		public function get offsetBg():int {
			return _offsetBg;
		}
		
		public function set offsetBg(value:int):void {
			_offsetBg = value;
