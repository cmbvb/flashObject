	...
	public class Tree extends Box implements IItem
	{
		...
		override protected function changeSize():void {
			...
			if (_scrollBar) {
				...
				_scrollBar.setScroll(0, _content.height - height, _scrollBar.value);
			}
			super.changeSize();
		}
