...
package com.canaan.lib.component.controls {
	...
	/**当滚动内容时调用*/
	[Event(name="scroll",type="com.canaan.lib.events.UIEvent")]
	...
	public class TextArea extends TextInput {
		...
		override protected function changeSize():void {
			...
			if (Boolean(_scrollBar.skin)) {
				...
				TimerManager.getInstance().doFrameOnce(1, onTextFieldScroll);
			}
		}
		
		override protected function changeText():void {
			super.changeText();
			_lineHeight = TextUtil.getTextField(_format).textHeight;
		}
		...
		protected function onTextFieldScroll(e:Event = null):void {
			if (Boolean(_scrollBar.skin)) {
