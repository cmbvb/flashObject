package com.canaan.lib.algorithm.behaviorTree.operator
{
	...
	public class BevNodePreconditionAND extends BevNodePrecondition
	{
		...
		public function BevNodePreconditionAND(leftCondition:BevNodePrecondition = null, rightCondition:BevNodePrecondition = null)
		{
		...
		override public function clone():BevNodePrecondition {
			return new BevNodePreconditionAND(mLeftCondition, mRighCondition);
		}
	}
}